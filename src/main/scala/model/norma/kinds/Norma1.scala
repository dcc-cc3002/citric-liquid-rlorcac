 ...
 */
class Norma1(goalType: String, player: Player) extends AbstractNorma(1, goalType, player) {
  override def next(nextGoalType: => String): Norma = new Norma2(nextGoalType, player)
}
